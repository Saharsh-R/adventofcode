    ...
    while files:
        ...
        for ijk , (i, spaces_empty) in enumerate(empty_spaces) :
            ...
            if file_size <= spaces_empty:
                system[i:i + file_size] =system[starting_index: starting_index + file_size]
...
@pytest.mark.parametrize('input, output', [
    ...
    (TEST_INPUT, [0, 0, 9, 9, 8, 1, 1, 1, 8, 8, 8, 2, 7, 7, 7, 3, 3, 3, 6, 4, 4, 6, 5, 5, 5, 5, 6, 6 ] )
])
